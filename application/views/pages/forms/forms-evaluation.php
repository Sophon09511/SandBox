                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if ($page == 'aec1') { ?>
                            ...
                            <form action="<?php echo site_url('Fm_evaluation/add_EVALUATION_CRITERIA'); ?>" method="post">
                        ...
                        <?php if ($page == 'aecl1') { ?>
                            ...
                            <form action="<?php echo site_url('Fm_evaluation/add_EVALUATION_CRITERIA_LEVEL'); ?>" method="post">
                        ...
                        <?php if ($page == 'aecc1') { ?>
                            ...
                            <form action="<?php echo site_url('Fm_evaluation/add_EVALUATION_CRITERIA_COMPOSITION'); ?>" method="post">
                        ...
                        <?php if ($page == 'aeccl1') { ?>
                            ...
                            <form action="<?php echo site_url('Fm_evaluation/add_EVALUATION_CRITERIA_COMPOSITION_LEVEL'); ?>" method="post">
                        ...
                        <?php if ($page == 'ase1') { ?>
                           ...
                           <form action="<?php echo site_url('Fm_evaluation/add_SCHOOL_EVALUATION'); ?>" method="post">
                       ...
                       <form action="<?php echo site_url('Fm_evaluation/add_SCHOOL_EVALUATION_CRITERIA'); ?>" method="post"> 
