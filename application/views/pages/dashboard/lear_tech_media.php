                ...
                <table class="table table-borderless datatable">
                    <thead>
                        ...
                        <th style="text-align: center;" scope="col">ปีการศึกษา</th>
                            ...
                            <th style="text-align: center;" scope="col">ชื่อการเรียนรู้</th>
                            <th style="text-align: center;" scope="col">ประเภทสื่อการเรียนรู้</th>
                            <th style="text-align: center;" scope="col">ผู้จัดทำ</th>
                            <th style="text-align: center;" scope="col">แหล่งที่มา</th>
                            <th style="text-align: center;" scope="col">ผู้เผยแพร่</th>
                    ...
                    <?php foreach ($query as $show ) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $show->MEDIA_TYPE_CODE; ?>
                            <th scope="row"><?php echo $show->ORGANIZER_NAME; ?></th>
                            <td style="text-align: center;"><?php echo $show->ORGANIZER_ORGANIZATION; ?>
                            ...
                            <th scope="row"><?php echo $show->PUBLISH_DATE; ?></th>
